<div class="container mx-auto px-4 py-8">
    <h2 class="text-2xl font-bold text-center mb-8 text-gray-800">Sản phẩm Mới</h2>
            ...
            <div class="bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
                ...
                <div class="p-4">
                    ...
                    <div class="flex justify-between items-center">
                        <span class="text-gray-900 text-lg font-bold">Giá: {{ number_format($product->price_buy) }}đ</span>
                        <a href="{{ route('site.product.detail', ['slug' => $product->slug]) }}"
